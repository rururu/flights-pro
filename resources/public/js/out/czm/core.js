...
var pitch = (function (){var pred__34556 = cljs.core._EQ_;
var expr__34557 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__34556.call(null,"UP",expr__34557))){
return (90);
} else {
if(cljs.core.truth_(pred__34556.call(null,"DOWN",expr__34557))){
return (-90);
} else {
...
var head = calc.geo.norm_crs.call(null,(function (){var pred__34559 = cljs.core._EQ_;
var expr__34560 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__34559.call(null,"BACKWARD",expr__34560))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__34559.call(null,"RIGHT",expr__34560))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__34559.call(null,"LEFT",expr__34560))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__34559.call(null,"FORWARD-RIGHT",expr__34560))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__34559.call(null,"FORWARD-LEFT",expr__34560))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__34559.call(null,"BACKWARD-RIGHT",expr__34560))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__34559.call(null,"BACKWARD-LEFT",expr__34560))){
return (crs - (135));
} else {
return crs;
}
