...
cljs.core.println.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ALT","ALT",1914430084),alt], null));

var pitch = (function (){var pred__20813 = cljs.core._EQ_;
var expr__20814 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__20813.call(null,"UP",expr__20814))){
return (90);
} else {
if(cljs.core.truth_(pred__20813.call(null,"DOWN",expr__20814))){
return (-90);
} else {
...
var head = calc.dynamic.norm_crs.call(null,(function (){var pred__20816 = cljs.core._EQ_;
var expr__20817 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__20816.call(null,"BACKWARD",expr__20817))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__20816.call(null,"RIGHT",expr__20817))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__20816.call(null,"LEFT",expr__20817))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__20816.call(null,"FORWARD-RIGHT",expr__20817))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__20816.call(null,"FORWARD-LEFT",expr__20817))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__20816.call(null,"BACKWARD-RIGHT",expr__20817))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__20816.call(null,"BACKWARD-LEFT",expr__20817))){
return (crs - (135));
} else {
return crs;
}
