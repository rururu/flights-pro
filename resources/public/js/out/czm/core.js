...
var pitch = (function (){var pred__42294 = cljs.core._EQ_;
var expr__42295 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__42294.call(null,"UP",expr__42295))){
return (90);
} else {
if(cljs.core.truth_(pred__42294.call(null,"DOWN",expr__42295))){
return (-90);
} else {
...
var head = calc.geo.norm_crs.call(null,(function (){var pred__42297 = cljs.core._EQ_;
var expr__42298 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__42297.call(null,"BACKWARD",expr__42298))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__42297.call(null,"RIGHT",expr__42298))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__42297.call(null,"LEFT",expr__42298))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__42297.call(null,"FORWARD-RIGHT",expr__42298))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__42297.call(null,"FORWARD-LEFT",expr__42298))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__42297.call(null,"BACKWARD-RIGHT",expr__42298))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__42297.call(null,"BACKWARD-LEFT",expr__42298))){
return (crs - (135));
} else {
return crs;
}
