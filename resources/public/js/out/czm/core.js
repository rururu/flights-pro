...
var pitch = (function (){var pred__25489 = cljs.core._EQ_;
var expr__25490 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__25489.call(null,"UP",expr__25490))){
return (90);
} else {
if(cljs.core.truth_(pred__25489.call(null,"DOWN",expr__25490))){
return (-90);
} else {
...
var head = calc.dynamic.norm_crs.call(null,(function (){var pred__25492 = cljs.core._EQ_;
var expr__25493 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__25492.call(null,"BACKWARD",expr__25493))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__25492.call(null,"RIGHT",expr__25493))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__25492.call(null,"LEFT",expr__25493))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__25492.call(null,"FORWARD-RIGHT",expr__25493))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__25492.call(null,"FORWARD-LEFT",expr__25493))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__25492.call(null,"BACKWARD-RIGHT",expr__25493))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__25492.call(null,"BACKWARD-LEFT",expr__25493))){
return (crs - (135));
} else {
return crs;
}
