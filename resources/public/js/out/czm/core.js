...
var pitch = (function (){var pred__31612 = cljs.core._EQ_;
var expr__31613 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__31612.call(null,"UP",expr__31613))){
return (90);
} else {
if(cljs.core.truth_(pred__31612.call(null,"DOWN",expr__31613))){
return (-90);
} else {
...
var head = calc.geo.norm_crs.call(null,(function (){var pred__31615 = cljs.core._EQ_;
var expr__31616 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__31615.call(null,"BACKWARD",expr__31616))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__31615.call(null,"RIGHT",expr__31616))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__31615.call(null,"LEFT",expr__31616))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__31615.call(null,"FORWARD-RIGHT",expr__31616))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__31615.call(null,"FORWARD-LEFT",expr__31616))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__31615.call(null,"BACKWARD-RIGHT",expr__31616))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__31615.call(null,"BACKWARD-LEFT",expr__31616))){
return (crs - (135));
} else {
return crs;
}
