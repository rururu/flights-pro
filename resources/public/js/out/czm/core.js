...
var pitch = (function (){var pred__25033 = cljs.core._EQ_;
var expr__25034 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__25033.call(null,"UP",expr__25034))){
return (90);
} else {
if(cljs.core.truth_(pred__25033.call(null,"DOWN",expr__25034))){
return (-90);
} else {
...
var head = calc.geo.norm_crs.call(null,(function (){var pred__25036 = cljs.core._EQ_;
var expr__25037 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__25036.call(null,"BACKWARD",expr__25037))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__25036.call(null,"RIGHT",expr__25037))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__25036.call(null,"LEFT",expr__25037))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__25036.call(null,"FORWARD-RIGHT",expr__25037))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__25036.call(null,"FORWARD-LEFT",expr__25037))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__25036.call(null,"BACKWARD-RIGHT",expr__25037))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__25036.call(null,"BACKWARD-LEFT",expr__25037))){
return (crs - (135));
} else {
return crs;
}
