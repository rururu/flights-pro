...
var pitch = (function (){var pred__60172 = cljs.core._EQ_;
var expr__60173 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__60172.call(null,"UP",expr__60173))){
return (90);
} else {
if(cljs.core.truth_(pred__60172.call(null,"DOWN",expr__60173))){
return (-90);
} else {
...
var head = calc.geo.norm_crs.call(null,(function (){var pred__60175 = cljs.core._EQ_;
var expr__60176 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__60175.call(null,"BACKWARD",expr__60176))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__60175.call(null,"RIGHT",expr__60176))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__60175.call(null,"LEFT",expr__60176))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__60175.call(null,"FORWARD-RIGHT",expr__60176))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__60175.call(null,"FORWARD-LEFT",expr__60176))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__60175.call(null,"BACKWARD-RIGHT",expr__60176))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__60175.call(null,"BACKWARD-LEFT",expr__60176))){
return (crs - (135));
} else {
return crs;
}
