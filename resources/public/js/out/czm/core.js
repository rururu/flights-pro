...
var pitch = (function (){var pred__28760 = cljs.core._EQ_;
var expr__28761 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__28760.call(null,"UP",expr__28761))){
return (90);
} else {
if(cljs.core.truth_(pred__28760.call(null,"DOWN",expr__28761))){
return (-90);
} else {
...
var head = calc.geo.norm_crs.call(null,(function (){var pred__28763 = cljs.core._EQ_;
var expr__28764 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__28763.call(null,"BACKWARD",expr__28764))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__28763.call(null,"RIGHT",expr__28764))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__28763.call(null,"LEFT",expr__28764))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__28763.call(null,"FORWARD-RIGHT",expr__28764))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__28763.call(null,"FORWARD-LEFT",expr__28764))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__28763.call(null,"BACKWARD-RIGHT",expr__28764))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__28763.call(null,"BACKWARD-LEFT",expr__28764))){
return (crs - (135));
} else {
return crs;
}
