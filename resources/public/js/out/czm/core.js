...
var vec__29986 = czm.core.FLY_CTL;
var lat = cljs.core.nth.call(null,vec__29986,(0),null);
var lon = cljs.core.nth.call(null,vec__29986,(1),null);
var alt = cljs.core.nth.call(null,vec__29986,(2),null);
var head = cljs.core.nth.call(null,vec__29986,(3),null);
var pitch = cljs.core.nth.call(null,vec__29986,(4),null);
var roll = cljs.core.nth.call(null,vec__29986,(5),null);
var per = cljs.core.nth.call(null,vec__29986,(6),null);
...
var pitch = (function (){var pred__29989 = cljs.core._EQ_;
var expr__29990 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__29989.call(null,"UP",expr__29990))){
return (90);
} else {
if(cljs.core.truth_(pred__29989.call(null,"DOWN",expr__29990))){
return (-90);
} else {
...
var roll = new cljs.core.Keyword(null,"roll","roll",11266999).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
var head = calc.geo.norm_crs.call(null,(function (){var pred__29992 = cljs.core._EQ_;
var expr__29993 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__29992.call(null,"BACKWARD",expr__29993))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__29992.call(null,"RIGHT",expr__29993))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__29992.call(null,"LEFT",expr__29993))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__29992.call(null,"FORWARD-RIGHT",expr__29993))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__29992.call(null,"FORWARD-LEFT",expr__29993))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__29992.call(null,"BACKWARD-RIGHT",expr__29993))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__29992.call(null,"BACKWARD-LEFT",expr__29993))){
return (crs - (135));
} else {
return crs;
}
