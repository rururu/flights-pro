...
var pitch = (function (){var pred__33351 = cljs.core._EQ_;
var expr__33352 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__33351.call(null,"UP",expr__33352))){
return (90);
} else {
if(cljs.core.truth_(pred__33351.call(null,"DOWN",expr__33352))){
return (-90);
} else {
...
var head = calc.geo.norm_crs.call(null,(function (){var pred__33354 = cljs.core._EQ_;
var expr__33355 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__33354.call(null,"BACKWARD",expr__33355))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__33354.call(null,"RIGHT",expr__33355))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__33354.call(null,"LEFT",expr__33355))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__33354.call(null,"FORWARD-RIGHT",expr__33355))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__33354.call(null,"FORWARD-LEFT",expr__33355))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__33354.call(null,"BACKWARD-RIGHT",expr__33355))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__33354.call(null,"BACKWARD-LEFT",expr__33355))){
return (crs - (135));
} else {
return crs;
}
