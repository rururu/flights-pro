...
var pitch = (function (){var pred__35528 = cljs.core._EQ_;
var expr__35529 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__35528.call(null,"UP",expr__35529))){
return (90);
} else {
if(cljs.core.truth_(pred__35528.call(null,"DOWN",expr__35529))){
return (-90);
} else {
...
var head = calc.geo.norm_crs.call(null,(function (){var pred__35531 = cljs.core._EQ_;
var expr__35532 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__35531.call(null,"BACKWARD",expr__35532))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__35531.call(null,"RIGHT",expr__35532))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__35531.call(null,"LEFT",expr__35532))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__35531.call(null,"FORWARD-RIGHT",expr__35532))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__35531.call(null,"FORWARD-LEFT",expr__35532))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__35531.call(null,"BACKWARD-RIGHT",expr__35532))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__35531.call(null,"BACKWARD-LEFT",expr__35532))){
return (crs - (135));
} else {
return crs;
}
