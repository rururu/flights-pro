...
var pitch = (function (){var pred__24056 = cljs.core._EQ_;
var expr__24057 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__24056.call(null,"UP",expr__24057))){
return (90);
} else {
if(cljs.core.truth_(pred__24056.call(null,"DOWN",expr__24057))){
return (-90);
} else {
...
var head = calc.dynamic.norm_crs.call(null,(function (){var pred__24059 = cljs.core._EQ_;
var expr__24060 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__24059.call(null,"BACKWARD",expr__24060))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__24059.call(null,"RIGHT",expr__24060))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__24059.call(null,"LEFT",expr__24060))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__24059.call(null,"FORWARD-RIGHT",expr__24060))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__24059.call(null,"FORWARD-LEFT",expr__24060))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__24059.call(null,"BACKWARD-RIGHT",expr__24060))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__24059.call(null,"BACKWARD-LEFT",expr__24060))){
return (crs - (135));
} else {
return crs;
}
...
return cljs.core._vreset_BANG_.call(null,czm.core.CAMERA,key.call(null,cljs.core._deref.call(null,czm.core.CAMERA),val));
});
