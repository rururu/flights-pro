...
var pitch = (function (){var pred__25957 = cljs.core._EQ_;
var expr__25958 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__25957.call(null,"UP",expr__25958))){
return (90);
} else {
if(cljs.core.truth_(pred__25957.call(null,"DOWN",expr__25958))){
return (-90);
} else {
...
var head = calc.geo.norm_crs.call(null,(function (){var pred__25960 = cljs.core._EQ_;
var expr__25961 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__25960.call(null,"BACKWARD",expr__25961))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__25960.call(null,"RIGHT",expr__25961))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__25960.call(null,"LEFT",expr__25961))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__25960.call(null,"FORWARD-RIGHT",expr__25961))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__25960.call(null,"FORWARD-LEFT",expr__25961))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__25960.call(null,"BACKWARD-RIGHT",expr__25961))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__25960.call(null,"BACKWARD-LEFT",expr__25961))){
return (crs - (135));
} else {
return crs;
}
