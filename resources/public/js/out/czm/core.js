...
var pitch = (function (){var pred__24118 = cljs.core._EQ_;
var expr__24119 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__24118.call(null,"UP",expr__24119))){
return (90);
} else {
if(cljs.core.truth_(pred__24118.call(null,"DOWN",expr__24119))){
return (-90);
} else {
...
var head = calc.geo.norm_crs.call(null,(function (){var pred__24121 = cljs.core._EQ_;
var expr__24122 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__24121.call(null,"BACKWARD",expr__24122))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__24121.call(null,"RIGHT",expr__24122))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__24121.call(null,"LEFT",expr__24122))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__24121.call(null,"FORWARD-RIGHT",expr__24122))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__24121.call(null,"FORWARD-LEFT",expr__24122))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__24121.call(null,"BACKWARD-RIGHT",expr__24122))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__24121.call(null,"BACKWARD-LEFT",expr__24122))){
return (crs - (135));
} else {
return crs;
}
