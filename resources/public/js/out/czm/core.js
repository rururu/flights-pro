...
var pitch = (function (){var pred__40745 = cljs.core._EQ_;
var expr__40746 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__40745.call(null,"UP",expr__40746))){
return (90);
} else {
if(cljs.core.truth_(pred__40745.call(null,"DOWN",expr__40746))){
return (-90);
} else {
...
var head = calc.geo.norm_crs.call(null,(function (){var pred__40748 = cljs.core._EQ_;
var expr__40749 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__40748.call(null,"BACKWARD",expr__40749))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__40748.call(null,"RIGHT",expr__40749))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__40748.call(null,"LEFT",expr__40749))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__40748.call(null,"FORWARD-RIGHT",expr__40749))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__40748.call(null,"FORWARD-LEFT",expr__40749))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__40748.call(null,"BACKWARD-RIGHT",expr__40749))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__40748.call(null,"BACKWARD-LEFT",expr__40749))){
return (crs - (135));
} else {
return crs;
}
