...
var pitch = (function (){var pred__30086 = cljs.core._EQ_;
var expr__30087 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__30086.call(null,"UP",expr__30087))){
return (90);
} else {
if(cljs.core.truth_(pred__30086.call(null,"DOWN",expr__30087))){
return (-90);
} else {
...
var head = calc.dynamic.norm_crs.call(null,(function (){var pred__30089 = cljs.core._EQ_;
var expr__30090 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__30089.call(null,"BACKWARD",expr__30090))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__30089.call(null,"RIGHT",expr__30090))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__30089.call(null,"LEFT",expr__30090))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__30089.call(null,"FORWARD-RIGHT",expr__30090))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__30089.call(null,"FORWARD-LEFT",expr__30090))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__30089.call(null,"BACKWARD-RIGHT",expr__30090))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__30089.call(null,"BACKWARD-LEFT",expr__30090))){
return (crs - (135));
} else {
return crs;
}
