...
var pitch = (function (){var pred__27747 = cljs.core._EQ_;
var expr__27748 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__27747.call(null,"UP",expr__27748))){
return (90);
} else {
if(cljs.core.truth_(pred__27747.call(null,"DOWN",expr__27748))){
return (-90);
} else {
...
var head = calc.geo.norm_crs.call(null,(function (){var pred__27750 = cljs.core._EQ_;
var expr__27751 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__27750.call(null,"BACKWARD",expr__27751))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__27750.call(null,"RIGHT",expr__27751))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__27750.call(null,"LEFT",expr__27751))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__27750.call(null,"FORWARD-RIGHT",expr__27751))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__27750.call(null,"FORWARD-LEFT",expr__27751))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__27750.call(null,"BACKWARD-RIGHT",expr__27751))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__27750.call(null,"BACKWARD-LEFT",expr__27751))){
return (crs - (135));
} else {
return crs;
}
