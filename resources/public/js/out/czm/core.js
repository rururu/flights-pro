...
var pitch = (function (){var pred__21783 = cljs.core._EQ_;
var expr__21784 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__21783.call(null,"UP",expr__21784))){
return (90);
} else {
if(cljs.core.truth_(pred__21783.call(null,"DOWN",expr__21784))){
return (-90);
} else {
...
var head = calc.dynamic.norm_crs.call(null,(function (){var pred__21786 = cljs.core._EQ_;
var expr__21787 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__21786.call(null,"BACKWARD",expr__21787))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__21786.call(null,"RIGHT",expr__21787))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__21786.call(null,"LEFT",expr__21787))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__21786.call(null,"FORWARD-RIGHT",expr__21787))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__21786.call(null,"FORWARD-LEFT",expr__21787))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__21786.call(null,"BACKWARD-RIGHT",expr__21787))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__21786.call(null,"BACKWARD-LEFT",expr__21787))){
return (crs - (135));
} else {
return crs;
}
