...
var pitch = (function (){var pred__29266 = cljs.core._EQ_;
var expr__29267 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__29266.call(null,"UP",expr__29267))){
return (90);
} else {
if(cljs.core.truth_(pred__29266.call(null,"DOWN",expr__29267))){
return (-90);
} else {
...
var head = calc.geo.norm_crs.call(null,(function (){var pred__29269 = cljs.core._EQ_;
var expr__29270 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__29269.call(null,"BACKWARD",expr__29270))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__29269.call(null,"RIGHT",expr__29270))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__29269.call(null,"LEFT",expr__29270))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__29269.call(null,"FORWARD-RIGHT",expr__29270))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__29269.call(null,"FORWARD-LEFT",expr__29270))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__29269.call(null,"BACKWARD-RIGHT",expr__29270))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__29269.call(null,"BACKWARD-LEFT",expr__29270))){
return (crs - (135));
} else {
return crs;
}
