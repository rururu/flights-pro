...
var pitch = (function (){var pred__34697 = cljs.core._EQ_;
var expr__34698 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__34697.call(null,"UP",expr__34698))){
return (90);
} else {
if(cljs.core.truth_(pred__34697.call(null,"DOWN",expr__34698))){
return (-90);
} else {
...
var head = calc.geo.norm_crs.call(null,(function (){var pred__34700 = cljs.core._EQ_;
var expr__34701 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__34700.call(null,"BACKWARD",expr__34701))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__34700.call(null,"RIGHT",expr__34701))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__34700.call(null,"LEFT",expr__34701))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__34700.call(null,"FORWARD-RIGHT",expr__34701))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__34700.call(null,"FORWARD-LEFT",expr__34701))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__34700.call(null,"BACKWARD-RIGHT",expr__34701))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__34700.call(null,"BACKWARD-LEFT",expr__34701))){
return (crs - (135));
} else {
return crs;
}
