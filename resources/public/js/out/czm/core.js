...
var pitch = (function (){var pred__21693 = cljs.core._EQ_;
var expr__21694 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__21693.call(null,"UP",expr__21694))){
return (90);
} else {
if(cljs.core.truth_(pred__21693.call(null,"DOWN",expr__21694))){
return (-90);
} else {
...
var head = calc.dynamic.norm_crs.call(null,(function (){var pred__21696 = cljs.core._EQ_;
var expr__21697 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__21696.call(null,"BACKWARD",expr__21697))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__21696.call(null,"RIGHT",expr__21697))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__21696.call(null,"LEFT",expr__21697))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__21696.call(null,"FORWARD-RIGHT",expr__21697))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__21696.call(null,"FORWARD-LEFT",expr__21697))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__21696.call(null,"BACKWARD-RIGHT",expr__21697))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__21696.call(null,"BACKWARD-LEFT",expr__21697))){
return (crs - (135));
} else {
return crs;
}
