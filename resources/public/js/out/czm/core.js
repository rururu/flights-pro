...
var pitch = (function (){var pred__29285 = cljs.core._EQ_;
var expr__29286 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__29285.call(null,"UP",expr__29286))){
return (90);
} else {
if(cljs.core.truth_(pred__29285.call(null,"DOWN",expr__29286))){
return (-90);
} else {
...
var head = calc.dynamic.norm_crs.call(null,(function (){var pred__29288 = cljs.core._EQ_;
var expr__29289 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__29288.call(null,"BACKWARD",expr__29289))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__29288.call(null,"RIGHT",expr__29289))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__29288.call(null,"LEFT",expr__29289))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__29288.call(null,"FORWARD-RIGHT",expr__29289))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__29288.call(null,"FORWARD-LEFT",expr__29289))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__29288.call(null,"BACKWARD-RIGHT",expr__29289))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__29288.call(null,"BACKWARD-LEFT",expr__29289))){
return (crs - (135));
} else {
return crs;
}
