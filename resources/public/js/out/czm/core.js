...
var pitch = (function (){var pred__23233 = cljs.core._EQ_;
var expr__23234 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__23233.call(null,"UP",expr__23234))){
return (90);
} else {
if(cljs.core.truth_(pred__23233.call(null,"DOWN",expr__23234))){
return (-90);
} else {
...
var head = calc.dynamic.norm_crs.call(null,(function (){var pred__23236 = cljs.core._EQ_;
var expr__23237 = new cljs.core.Keyword(null,"view","view",1247994814).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,czm.core.CAMERA));
if(cljs.core.truth_(pred__23236.call(null,"BACKWARD",expr__23237))){
return (crs + (180));
} else {
if(cljs.core.truth_(pred__23236.call(null,"RIGHT",expr__23237))){
return (crs + (90));
} else {
if(cljs.core.truth_(pred__23236.call(null,"LEFT",expr__23237))){
return (crs - (90));
} else {
if(cljs.core.truth_(pred__23236.call(null,"FORWARD-RIGHT",expr__23237))){
return (crs + (45));
} else {
if(cljs.core.truth_(pred__23236.call(null,"FORWARD-LEFT",expr__23237))){
return (crs - (45));
} else {
if(cljs.core.truth_(pred__23236.call(null,"BACKWARD-RIGHT",expr__23237))){
return (crs + (135));
} else {
if(cljs.core.truth_(pred__23236.call(null,"BACKWARD-LEFT",expr__23237))){
return (crs - (135));
} else {
return crs;
}
