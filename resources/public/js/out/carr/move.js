...
carr.move.future_pos = (function carr$move$future_pos(p__21807,crs,spd,tim){
var vec__21814 = p__21807;
var lat = cljs.core.nth.call(null,vec__21814,(0),null);
var lon = cljs.core.nth.call(null,vec__21814,(1),null);
var phi = (carr.move.PID180 * lat);
var lam = (carr.move.PID180 * lon);
var dir = (carr.move.PID180 * crs);
var way = (spd * tim);
var way__$1 = (carr.move.PID180 * (way / (60)));
var vec__21817 = carr.move.spherical_between.call(null,phi,lam,way__$1,dir);
var phi2 = cljs.core.nth.call(null,vec__21817,(0),null);
var lam2 = cljs.core.nth.call(null,vec__21817,(1),null);
