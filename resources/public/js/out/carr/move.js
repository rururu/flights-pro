...
var args21719 = [];
var len__20476__auto___21726 = arguments.length;
var i__20477__auto___21727 = (0);
while(true){
if((i__20477__auto___21727 < len__20476__auto___21726)){
args21719.push((arguments[i__20477__auto___21727]));

var G__21728 = (i__20477__auto___21727 + (1));
i__20477__auto___21727 = G__21728;
continue;
} else {
}
break;
...
carr.move.set_turn_point.cljs$core$IFn$_invoke$arity$4 = (function (carr__$1,p__21722,crs,spd){
var vec__21723 = p__21722;
var lat = cljs.core.nth.call(null,vec__21723,(0),null);
var lon = cljs.core.nth.call(null,vec__21723,(1),null);
...
var vec__21733 = carr.move.spherical_between_js.call(null,new cljs.core.Keyword(null,"phi","phi",-1526798304).cljs$core$IFn$_invoke$arity$1(tur),new cljs.core.Keyword(null,"lam","lam",1907357070).cljs$core$IFn$_invoke$arity$1(tur),way,new cljs.core.Keyword(null,"dir","dir",1734754661).cljs$core$IFn$_invoke$arity$1(tur));
var phi = cljs.core.nth.call(null,vec__21733,(0),null);
var lam = cljs.core.nth.call(null,vec__21733,(1),null);
...
carr.move.turn = (function carr$move$turn(carr__$1,course,accel){
...
carr.move.accel = (function carr$move$accel(carr__$1,speed){
...
carr.move.elevate = (function carr$move$elevate(carr__$1,altitude){
