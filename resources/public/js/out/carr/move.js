...
carr.move.future_pos = (function carr$move$future_pos(p__24035,crs,spd,tim){
var vec__24042 = p__24035;
var lat = cljs.core.nth.call(null,vec__24042,(0),null);
var lon = cljs.core.nth.call(null,vec__24042,(1),null);
var phi = (carr.move.PID180 * lat);
var lam = (carr.move.PID180 * lon);
var dir = (carr.move.PID180 * crs);
var way = (spd * tim);
var way__$1 = (carr.move.PID180 * (way / (60)));
var vec__24045 = carr.move.spherical_between.call(null,phi,lam,way__$1,dir);
var phi2 = cljs.core.nth.call(null,vec__24045,(0),null);
var lam2 = cljs.core.nth.call(null,vec__24045,(1),null);
...
carr.move.turn = (function carr$move$turn(carr__$1,course){
...
return calc.dynamic.equalize.call(null,carr__$1,new cljs.core.Keyword(null,"rudder","rudder",1071257290),new cljs.core.Keyword(null,"course","course",1455432948),calc.dynamic.course_closer);
});
...
return calc.dynamic.equalize.call(null,carr__$1,new cljs.core.Keyword(null,"engine","engine",1459054265),new cljs.core.Keyword(null,"speed","speed",1257663751),calc.dynamic.step_closer);
});
