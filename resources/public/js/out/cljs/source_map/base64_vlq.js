...
var digit_11814 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_11815__$1 = (vlq >>> cljs.source_map.base64_vlq.vlq_base_shift);
while(true){
if((vlq_11815__$1 > (0))){
var digit_11816__$1 = (digit_11814 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_11816__$1));

var G__11817 = (vlq_11815__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__11818 = (vlq_11815__$1 >>> cljs.source_map.base64_vlq.vlq_base_shift);
digit_11814 = G__11817;
vlq_11815__$1 = G__11818;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_11814));
}
break;
}
...
var G__11819 = i__$1;
var G__11820 = result__$1;
var G__11821 = shift__$1;
i = G__11819;
result = G__11820;
shift = G__11821;
continue;
