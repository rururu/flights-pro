...
var G__2627 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__2627;
continue;
} else {
return ch;
...
var vec__2628 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__2628,(0),null);
return (match === s);
});
...
var len__4641__auto___2633 = arguments.length;
var i__4642__auto___2634 = (0);
while(true){
if((i__4642__auto___2634 < len__4641__auto___2633)){
args__4647__auto__.push((arguments[i__4642__auto___2634]));

var G__2635 = (i__4642__auto___2634 + (1));
i__4642__auto___2634 = G__2635;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq2631){
...
return (function() { 
var G__2636__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__2636 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__2637__i = 0, G__2637__a = new Array(arguments.length -  1);
while (G__2637__i < G__2637__a.length) {G__2637__a[G__2637__i] = arguments[G__2637__i + 1]; ++G__2637__i;}
  _ = new cljs.core.IndexedSeq(G__2637__a,0,null);
} 
return G__2636__delegate.call(this,rdr,_);};
G__2636.cljs$lang$maxFixedArity = 1;
G__2636.cljs$lang$applyTo = (function (arglist__2638){
var rdr = cljs.core.first(arglist__2638);
var _ = cljs.core.rest(arglist__2638);
return G__2636__delegate(rdr,_);
});
