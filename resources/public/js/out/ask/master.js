...
var status = cljs.core.get.call(null,map__25638__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
var status_text = cljs.core.get.call(null,map__25638__$1,new cljs.core.Keyword(null,"status-text","status-text",-1834235478));
...
var pred__25651 = cljs.core._EQ_;
var expr__25652 = typ;
if(cljs.core.truth_(pred__25651.call(null,new cljs.core.Keyword(null,"itself","itself",1264932322),expr__25652))){
return cljs.core.apply.call(null,cljs.core.str,(function (){var iter__22541__auto__ = ((function (pred__25651,expr__25652){
return (function ask$master$options_$_iter__25654(s__25655){
return (new cljs.core.LazySeq(null,((function (pred__25651,expr__25652){
return (function (){
...
var c__22539__auto__ = cljs.core.chunk_first.call(null,s__25655__$2);
var size__22540__auto__ = cljs.core.count.call(null,c__22539__auto__);
var b__25657 = cljs.core.chunk_buffer.call(null,size__22540__auto__);
if((function (){var i__25656 = (0);
while(true){
if((i__25656 < size__22540__auto__)){
var e = cljs.core._nth.call(null,c__22539__auto__,i__25656);
cljs.core.chunk_append.call(null,b__25657,[cljs.core.str("<option value='"),cljs.core.str(e),cljs.core.str("'>"),cljs.core.str(e),cljs.core.str("</option>")].join(''));

var G__25662 = (i__25656 + (1));
i__25656 = G__25662;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__25657),ask$master$options_$_iter__25654.call(null,cljs.core.chunk_rest.call(null,s__25655__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__25657),null);
}
} else {
var e = cljs.core.first.call(null,s__25655__$2);
return cljs.core.cons.call(null,[cljs.core.str("<option value='"),cljs.core.str(e),cljs.core.str("'>"),cljs.core.str(e),cljs.core.str("</option>")].join(''),ask$master$options_$_iter__25654.call(null,cljs.core.rest.call(null,s__25655__$2)));
}
} else {
return null;
}
...
});})(pred__25651,expr__25652))
,null,null));
});})(pred__25651,expr__25652))
;
return iter__22541__auto__.call(null,lst);
})());
} else {
if(cljs.core.truth_(pred__25651.call(null,new cljs.core.Keyword(null,"count","count",2139924085),expr__25652))){
return cljs.core.apply.call(null,cljs.core.str,(function (){var iter__22541__auto__ = ((function (pred__25651,expr__25652){
return (function ask$master$options_$_iter__25658(s__25659){
return (new cljs.core.LazySeq(null,((function (pred__25651,expr__25652){
return (function (){
var s__25659__$1 = s__25659;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__25659__$1);
if(temp__4657__auto__){
var s__25659__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__25659__$2)){
var c__22539__auto__ = cljs.core.chunk_first.call(null,s__25659__$2);
var size__22540__auto__ = cljs.core.count.call(null,c__22539__auto__);
var b__25661 = cljs.core.chunk_buffer.call(null,size__22540__auto__);
if((function (){var i__25660 = (0);
while(true){
if((i__25660 < size__22540__auto__)){
var i = cljs.core._nth.call(null,c__22539__auto__,i__25660);
cljs.core.chunk_append.call(null,b__25661,[cljs.core.str("<option value='"),cljs.core.str(i),cljs.core.str("'>"),cljs.core.str(cljs.core.nth.call(null,lst,i)),cljs.core.str("</option>")].join(''));

var G__25663 = (i__25660 + (1));
i__25660 = G__25663;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__25661),ask$master$options_$_iter__25658.call(null,cljs.core.chunk_rest.call(null,s__25659__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__25661),null);
}
} else {
var i = cljs.core.first.call(null,s__25659__$2);
return cljs.core.cons.call(null,[cljs.core.str("<option value='"),cljs.core.str(i),cljs.core.str("'>"),cljs.core.str(cljs.core.nth.call(null,lst,i)),cljs.core.str("</option>")].join(''),ask$master$options_$_iter__25658.call(null,cljs.core.rest.call(null,s__25659__$2)));
}
} else {
return null;
}
...
;
return iter__22541__auto__.call(null,cljs.core.range.call(null,cljs.core.count.call(null,lst)));
})());
} else {
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__25652)].join('')));
}
}
});
