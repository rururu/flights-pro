...
var status = cljs.core.get.call(null,map__30918__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
var status_text = cljs.core.get.call(null,map__30918__$1,new cljs.core.Keyword(null,"status-text","status-text",-1834235478));
...
var pred__30931 = cljs.core._EQ_;
var expr__30932 = typ;
if(cljs.core.truth_(pred__30931.call(null,new cljs.core.Keyword(null,"itself","itself",1264932322),expr__30932))){
return cljs.core.apply.call(null,cljs.core.str,(function (){var iter__21352__auto__ = ((function (pred__30931,expr__30932){
return (function ask$master$options_$_iter__30934(s__30935){
return (new cljs.core.LazySeq(null,((function (pred__30931,expr__30932){
return (function (){
...
var c__21350__auto__ = cljs.core.chunk_first.call(null,s__30935__$2);
var size__21351__auto__ = cljs.core.count.call(null,c__21350__auto__);
var b__30937 = cljs.core.chunk_buffer.call(null,size__21351__auto__);
if((function (){var i__30936 = (0);
while(true){
if((i__30936 < size__21351__auto__)){
var e = cljs.core._nth.call(null,c__21350__auto__,i__30936);
cljs.core.chunk_append.call(null,b__30937,[cljs.core.str("<option value='"),cljs.core.str(e),cljs.core.str("'>"),cljs.core.str(e),cljs.core.str("</option>")].join(''));
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__30937),ask$master$options_$_iter__30934.call(null,cljs.core.chunk_rest.call(null,s__30935__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__30937),null);
}
} else {
var e = cljs.core.first.call(null,s__30935__$2);
return cljs.core.cons.call(null,[cljs.core.str("<option value='"),cljs.core.str(e),cljs.core.str("'>"),cljs.core.str(e),cljs.core.str("</option>")].join(''),ask$master$options_$_iter__30934.call(null,cljs.core.rest.call(null,s__30935__$2)));
}
} else {
return null;
}
...
});})(pred__30931,expr__30932))
,null,null));
});})(pred__30931,expr__30932))
;
return iter__21352__auto__.call(null,lst);
})());
} else {
if(cljs.core.truth_(pred__30931.call(null,new cljs.core.Keyword(null,"count","count",2139924085),expr__30932))){
return cljs.core.apply.call(null,cljs.core.str,(function (){var iter__21352__auto__ = ((function (pred__30931,expr__30932){
return (function ask$master$options_$_iter__30938(s__30939){
return (new cljs.core.LazySeq(null,((function (pred__30931,expr__30932){
return (function (){
var s__30939__$1 = s__30939;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__30939__$1);
if(temp__4657__auto__){
var s__30939__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__30939__$2)){
var c__21350__auto__ = cljs.core.chunk_first.call(null,s__30939__$2);
var size__21351__auto__ = cljs.core.count.call(null,c__21350__auto__);
var b__30941 = cljs.core.chunk_buffer.call(null,size__21351__auto__);
if((function (){var i__30940 = (0);
while(true){
if((i__30940 < size__21351__auto__)){
var i = cljs.core._nth.call(null,c__21350__auto__,i__30940);
cljs.core.chunk_append.call(null,b__30941,[cljs.core.str("<option value='"),cljs.core.str(i),cljs.core.str("'>"),cljs.core.str(cljs.core.nth.call(null,lst,i)),cljs.core.str("</option>")].join(''));

var G__30943 = (i__30940 + (1));
i__30940 = G__30943;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__30941),ask$master$options_$_iter__30938.call(null,cljs.core.chunk_rest.call(null,s__30939__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__30941),null);
}
} else {
var i = cljs.core.first.call(null,s__30939__$2);
return cljs.core.cons.call(null,[cljs.core.str("<option value='"),cljs.core.str(i),cljs.core.str("'>"),cljs.core.str(cljs.core.nth.call(null,lst,i)),cljs.core.str("</option>")].join(''),ask$master$options_$_iter__30938.call(null,cljs.core.rest.call(null,s__30939__$2)));
}
} else {
return null;
}
...
;
return iter__21352__auto__.call(null,cljs.core.range.call(null,cljs.core.count.call(null,lst)));
})());
} else {
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__30932)].join('')));
}
}
});
