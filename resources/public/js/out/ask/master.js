...
var status = cljs.core.get.call(null,map__31629__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
var status_text = cljs.core.get.call(null,map__31629__$1,new cljs.core.Keyword(null,"status-text","status-text",-1834235478));
...
var pred__31642 = cljs.core._EQ_;
var expr__31643 = typ;
if(cljs.core.truth_(pred__31642.call(null,new cljs.core.Keyword(null,"itself","itself",1264932322),expr__31643))){
return cljs.core.apply.call(null,cljs.core.str,(function (){var iter__20213__auto__ = ((function (pred__31642,expr__31643){
return (function ask$master$options_$_iter__31645(s__31646){
return (new cljs.core.LazySeq(null,((function (pred__31642,expr__31643){
return (function (){
...
var c__20211__auto__ = cljs.core.chunk_first.call(null,s__31646__$2);
var size__20212__auto__ = cljs.core.count.call(null,c__20211__auto__);
var b__31648 = cljs.core.chunk_buffer.call(null,size__20212__auto__);
if((function (){var i__31647 = (0);
while(true){
if((i__31647 < size__20212__auto__)){
var e = cljs.core._nth.call(null,c__20211__auto__,i__31647);
cljs.core.chunk_append.call(null,b__31648,[cljs.core.str("<option value='"),cljs.core.str(e),cljs.core.str("'>"),cljs.core.str(e),cljs.core.str("</option>")].join(''));

var G__31653 = (i__31647 + (1));
i__31647 = G__31653;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__31648),ask$master$options_$_iter__31645.call(null,cljs.core.chunk_rest.call(null,s__31646__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__31648),null);
}
} else {
var e = cljs.core.first.call(null,s__31646__$2);
return cljs.core.cons.call(null,[cljs.core.str("<option value='"),cljs.core.str(e),cljs.core.str("'>"),cljs.core.str(e),cljs.core.str("</option>")].join(''),ask$master$options_$_iter__31645.call(null,cljs.core.rest.call(null,s__31646__$2)));
}
} else {
return null;
}
...
});})(pred__31642,expr__31643))
,null,null));
});})(pred__31642,expr__31643))
;
return iter__20213__auto__.call(null,lst);
})());
} else {
if(cljs.core.truth_(pred__31642.call(null,new cljs.core.Keyword(null,"count","count",2139924085),expr__31643))){
return cljs.core.apply.call(null,cljs.core.str,(function (){var iter__20213__auto__ = ((function (pred__31642,expr__31643){
return (function ask$master$options_$_iter__31649(s__31650){
return (new cljs.core.LazySeq(null,((function (pred__31642,expr__31643){
return (function (){
var s__31650__$1 = s__31650;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__31650__$1);
if(temp__4657__auto__){
var s__31650__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__31650__$2)){
var c__20211__auto__ = cljs.core.chunk_first.call(null,s__31650__$2);
var size__20212__auto__ = cljs.core.count.call(null,c__20211__auto__);
var b__31652 = cljs.core.chunk_buffer.call(null,size__20212__auto__);
if((function (){var i__31651 = (0);
while(true){
if((i__31651 < size__20212__auto__)){
var i = cljs.core._nth.call(null,c__20211__auto__,i__31651);
cljs.core.chunk_append.call(null,b__31652,[cljs.core.str("<option value='"),cljs.core.str(i),cljs.core.str("'>"),cljs.core.str(cljs.core.nth.call(null,lst,i)),cljs.core.str("</option>")].join(''));

var G__31654 = (i__31651 + (1));
i__31651 = G__31654;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__31652),ask$master$options_$_iter__31649.call(null,cljs.core.chunk_rest.call(null,s__31650__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__31652),null);
}
} else {
var i = cljs.core.first.call(null,s__31650__$2);
return cljs.core.cons.call(null,[cljs.core.str("<option value='"),cljs.core.str(i),cljs.core.str("'>"),cljs.core.str(cljs.core.nth.call(null,lst,i)),cljs.core.str("</option>")].join(''),ask$master$options_$_iter__31649.call(null,cljs.core.rest.call(null,s__31650__$2)));
}
} else {
return null;
}
...
;
return iter__20213__auto__.call(null,cljs.core.range.call(null,cljs.core.count.call(null,lst)));
})());
} else {
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__31643)].join('')));
}
}
});
