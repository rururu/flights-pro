...
var map__60189 = response;
var map__60189__$1 = ((((!((map__60189 == null)))?((((map__60189.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__60189.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__60189):map__60189);
var status = cljs.core.get.call(null,map__60189__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
var status_text = cljs.core.get.call(null,map__60189__$1,new cljs.core.Keyword(null,"status-text","status-text",-1834235478));
...
var pred__60202 = cljs.core._EQ_;
var expr__60203 = typ;
if(cljs.core.truth_(pred__60202.call(null,new cljs.core.Keyword(null,"itself","itself",1264932322),expr__60203))){
return cljs.core.apply.call(null,cljs.core.str,(function (){var iter__47914__auto__ = ((function (pred__60202,expr__60203){
return (function ask$master$options_$_iter__60205(s__60206){
return (new cljs.core.LazySeq(null,((function (pred__60202,expr__60203){
return (function (){
var s__60206__$1 = s__60206;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__60206__$1);
if(temp__4657__auto__){
var s__60206__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__60206__$2)){
var c__47912__auto__ = cljs.core.chunk_first.call(null,s__60206__$2);
var size__47913__auto__ = cljs.core.count.call(null,c__47912__auto__);
var b__60208 = cljs.core.chunk_buffer.call(null,size__47913__auto__);
if((function (){var i__60207 = (0);
while(true){
if((i__60207 < size__47913__auto__)){
var e = cljs.core._nth.call(null,c__47912__auto__,i__60207);
cljs.core.chunk_append.call(null,b__60208,[cljs.core.str("<option value='"),cljs.core.str(e),cljs.core.str("'>"),cljs.core.str(e),cljs.core.str("</option>")].join(''));

var G__60213 = (i__60207 + (1));
i__60207 = G__60213;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__60208),ask$master$options_$_iter__60205.call(null,cljs.core.chunk_rest.call(null,s__60206__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__60208),null);
}
} else {
var e = cljs.core.first.call(null,s__60206__$2);
return cljs.core.cons.call(null,[cljs.core.str("<option value='"),cljs.core.str(e),cljs.core.str("'>"),cljs.core.str(e),cljs.core.str("</option>")].join(''),ask$master$options_$_iter__60205.call(null,cljs.core.rest.call(null,s__60206__$2)));
}
} else {
return null;
}
...
});})(pred__60202,expr__60203))
,null,null));
});})(pred__60202,expr__60203))
;
return iter__47914__auto__.call(null,lst);
})());
} else {
if(cljs.core.truth_(pred__60202.call(null,new cljs.core.Keyword(null,"count","count",2139924085),expr__60203))){
return cljs.core.apply.call(null,cljs.core.str,(function (){var iter__47914__auto__ = ((function (pred__60202,expr__60203){
return (function ask$master$options_$_iter__60209(s__60210){
return (new cljs.core.LazySeq(null,((function (pred__60202,expr__60203){
return (function (){
var s__60210__$1 = s__60210;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__60210__$1);
if(temp__4657__auto__){
var s__60210__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__60210__$2)){
var c__47912__auto__ = cljs.core.chunk_first.call(null,s__60210__$2);
var size__47913__auto__ = cljs.core.count.call(null,c__47912__auto__);
var b__60212 = cljs.core.chunk_buffer.call(null,size__47913__auto__);
if((function (){var i__60211 = (0);
while(true){
if((i__60211 < size__47913__auto__)){
var i = cljs.core._nth.call(null,c__47912__auto__,i__60211);
cljs.core.chunk_append.call(null,b__60212,[cljs.core.str("<option value='"),cljs.core.str(i),cljs.core.str("'>"),cljs.core.str(cljs.core.nth.call(null,lst,i)),cljs.core.str("</option>")].join(''));

var G__60214 = (i__60211 + (1));
i__60211 = G__60214;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__60212),ask$master$options_$_iter__60209.call(null,cljs.core.chunk_rest.call(null,s__60210__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__60212),null);
}
} else {
var i = cljs.core.first.call(null,s__60210__$2);
return cljs.core.cons.call(null,[cljs.core.str("<option value='"),cljs.core.str(i),cljs.core.str("'>"),cljs.core.str(cljs.core.nth.call(null,lst,i)),cljs.core.str("</option>")].join(''),ask$master$options_$_iter__60209.call(null,cljs.core.rest.call(null,s__60210__$2)));
}
} else {
return null;
}
...
;
return iter__47914__auto__.call(null,cljs.core.range.call(null,cljs.core.count.call(null,lst)));
})());
} else {
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__60203)].join('')));
}
}
});
