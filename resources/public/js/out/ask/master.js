...
var status = cljs.core.get.call(null,map__23061__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
var status_text = cljs.core.get.call(null,map__23061__$1,new cljs.core.Keyword(null,"status-text","status-text",-1834235478));
...
var pred__23074 = cljs.core._EQ_;
var expr__23075 = typ;
if(cljs.core.truth_(pred__23074.call(null,new cljs.core.Keyword(null,"itself","itself",1264932322),expr__23075))){
return cljs.core.apply.call(null,cljs.core.str,(function (){var iter__21176__auto__ = ((function (pred__23074,expr__23075){
return (function ask$master$options_$_iter__23077(s__23078){
return (new cljs.core.LazySeq(null,((function (pred__23074,expr__23075){
return (function (){
var s__23078__$1 = s__23078;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__23078__$1);
if(temp__4657__auto__){
var s__23078__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__23078__$2)){
var c__21174__auto__ = cljs.core.chunk_first.call(null,s__23078__$2);
var size__21175__auto__ = cljs.core.count.call(null,c__21174__auto__);
var b__23080 = cljs.core.chunk_buffer.call(null,size__21175__auto__);
if((function (){var i__23079 = (0);
while(true){
if((i__23079 < size__21175__auto__)){
var e = cljs.core._nth.call(null,c__21174__auto__,i__23079);
cljs.core.chunk_append.call(null,b__23080,[cljs.core.str("<option value='"),cljs.core.str(e),cljs.core.str("'>"),cljs.core.str(e),cljs.core.str("</option>")].join(''));

var G__23085 = (i__23079 + (1));
i__23079 = G__23085;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__23080),ask$master$options_$_iter__23077.call(null,cljs.core.chunk_rest.call(null,s__23078__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__23080),null);
}
} else {
var e = cljs.core.first.call(null,s__23078__$2);
return cljs.core.cons.call(null,[cljs.core.str("<option value='"),cljs.core.str(e),cljs.core.str("'>"),cljs.core.str(e),cljs.core.str("</option>")].join(''),ask$master$options_$_iter__23077.call(null,cljs.core.rest.call(null,s__23078__$2)));
}
} else {
return null;
}
...
if(cljs.core.truth_(pred__23074.call(null,new cljs.core.Keyword(null,"count","count",2139924085),expr__23075))){
return cljs.core.apply.call(null,cljs.core.str,(function (){var iter__21176__auto__ = ((function (pred__23074,expr__23075){
return (function ask$master$options_$_iter__23081(s__23082){
return (new cljs.core.LazySeq(null,((function (pred__23074,expr__23075){
return (function (){
var s__23082__$1 = s__23082;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__23082__$1);
if(temp__4657__auto__){
var s__23082__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__23082__$2)){
var c__21174__auto__ = cljs.core.chunk_first.call(null,s__23082__$2);
var size__21175__auto__ = cljs.core.count.call(null,c__21174__auto__);
var b__23084 = cljs.core.chunk_buffer.call(null,size__21175__auto__);
if((function (){var i__23083 = (0);
while(true){
if((i__23083 < size__21175__auto__)){
var i = cljs.core._nth.call(null,c__21174__auto__,i__23083);
cljs.core.chunk_append.call(null,b__23084,[cljs.core.str("<option value='"),cljs.core.str(i),cljs.core.str("'>"),cljs.core.str(cljs.core.nth.call(null,lst,i)),cljs.core.str("</option>")].join(''));

var G__23086 = (i__23083 + (1));
i__23083 = G__23086;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__23084),ask$master$options_$_iter__23081.call(null,cljs.core.chunk_rest.call(null,s__23082__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__23084),null);
}
} else {
var i = cljs.core.first.call(null,s__23082__$2);
return cljs.core.cons.call(null,[cljs.core.str("<option value='"),cljs.core.str(i),cljs.core.str("'>"),cljs.core.str(cljs.core.nth.call(null,lst,i)),cljs.core.str("</option>")].join(''),ask$master$options_$_iter__23081.call(null,cljs.core.rest.call(null,s__23082__$2)));
}
} else {
return null;
}
...
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__23075)].join('')));
}
}
});
