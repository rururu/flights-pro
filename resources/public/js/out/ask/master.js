...
var status = cljs.core.get.call(null,map__32986__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
var status_text = cljs.core.get.call(null,map__32986__$1,new cljs.core.Keyword(null,"status-text","status-text",-1834235478));
...
var pred__32999 = cljs.core._EQ_;
var expr__33000 = typ;
if(cljs.core.truth_(pred__32999.call(null,new cljs.core.Keyword(null,"itself","itself",1264932322),expr__33000))){
return cljs.core.apply.call(null,cljs.core.str,(function (){var iter__30736__auto__ = ((function (pred__32999,expr__33000){
return (function ask$master$options_$_iter__33002(s__33003){
return (new cljs.core.LazySeq(null,((function (pred__32999,expr__33000){
return (function (){
...
var c__30734__auto__ = cljs.core.chunk_first.call(null,s__33003__$2);
var size__30735__auto__ = cljs.core.count.call(null,c__30734__auto__);
var b__33005 = cljs.core.chunk_buffer.call(null,size__30735__auto__);
if((function (){var i__33004 = (0);
while(true){
if((i__33004 < size__30735__auto__)){
var e = cljs.core._nth.call(null,c__30734__auto__,i__33004);
cljs.core.chunk_append.call(null,b__33005,[cljs.core.str("<option value='"),cljs.core.str(e),cljs.core.str("'>"),cljs.core.str(e),cljs.core.str("</option>")].join(''));

var G__33010 = (i__33004 + (1));
i__33004 = G__33010;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__33005),ask$master$options_$_iter__33002.call(null,cljs.core.chunk_rest.call(null,s__33003__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__33005),null);
}
} else {
var e = cljs.core.first.call(null,s__33003__$2);
return cljs.core.cons.call(null,[cljs.core.str("<option value='"),cljs.core.str(e),cljs.core.str("'>"),cljs.core.str(e),cljs.core.str("</option>")].join(''),ask$master$options_$_iter__33002.call(null,cljs.core.rest.call(null,s__33003__$2)));
}
} else {
return null;
}
...
});})(pred__32999,expr__33000))
,null,null));
});})(pred__32999,expr__33000))
;
return iter__30736__auto__.call(null,lst);
})());
} else {
if(cljs.core.truth_(pred__32999.call(null,new cljs.core.Keyword(null,"count","count",2139924085),expr__33000))){
return cljs.core.apply.call(null,cljs.core.str,(function (){var iter__30736__auto__ = ((function (pred__32999,expr__33000){
return (function ask$master$options_$_iter__33006(s__33007){
return (new cljs.core.LazySeq(null,((function (pred__32999,expr__33000){
return (function (){
var s__33007__$1 = s__33007;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__33007__$1);
if(temp__4657__auto__){
var s__33007__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__33007__$2)){
var c__30734__auto__ = cljs.core.chunk_first.call(null,s__33007__$2);
var size__30735__auto__ = cljs.core.count.call(null,c__30734__auto__);
var b__33009 = cljs.core.chunk_buffer.call(null,size__30735__auto__);
if((function (){var i__33008 = (0);
while(true){
if((i__33008 < size__30735__auto__)){
var i = cljs.core._nth.call(null,c__30734__auto__,i__33008);
cljs.core.chunk_append.call(null,b__33009,[cljs.core.str("<option value='"),cljs.core.str(i),cljs.core.str("'>"),cljs.core.str(cljs.core.nth.call(null,lst,i)),cljs.core.str("</option>")].join(''));

var G__33011 = (i__33008 + (1));
i__33008 = G__33011;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__33009),ask$master$options_$_iter__33006.call(null,cljs.core.chunk_rest.call(null,s__33007__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__33009),null);
}
} else {
var i = cljs.core.first.call(null,s__33007__$2);
return cljs.core.cons.call(null,[cljs.core.str("<option value='"),cljs.core.str(i),cljs.core.str("'>"),cljs.core.str(cljs.core.nth.call(null,lst,i)),cljs.core.str("</option>")].join(''),ask$master$options_$_iter__33006.call(null,cljs.core.rest.call(null,s__33007__$2)));
}
} else {
return null;
}
...
;
return iter__30736__auto__.call(null,cljs.core.range.call(null,cljs.core.count.call(null,lst)));
})());
} else {
throw (new Error([cljs.core.str("No matching clause: "),cljs.core.str(expr__33000)].join('')));
}
}
});
