...
var len__20745__auto___31077 = arguments.length;
var i__20746__auto___31078 = (0);
while(true){
if((i__20746__auto___31078 < len__20745__auto___31077)){
args__20752__auto__.push((arguments[i__20746__auto___31078]));

var G__31079 = (i__20746__auto___31078 + (1));
i__20746__auto___31078 = G__31079;
continue;
} else {
}
break;
...
var argseq__20753__auto__ = ((((1) < args__20752__auto__.length))?(new cljs.core.IndexedSeq(args__20752__auto__.slice((1)),(0),null)):null);
return view3d.controls.format.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__20753__auto__);
});
...
view3d.controls.format.cljs$lang$applyTo = (function (seq31075){
var G__31076 = cljs.core.first.call(null,seq31075);
var seq31075__$1 = cljs.core.next.call(null,seq31075);
return view3d.controls.format.cljs$core$IFn$_invoke$arity$variadic(G__31076,seq31075__$1);
});
...
view3d.controls.set_html_BANG_.call(null,"speed-tmp","<input value='1' style='width:6px' id='input-spdtmp'>");

view3d.controls.set_html_BANG_.call(null,"altitude-tmp","<input value='1' style='width:6px' id='input-alttmp'>");

view3d.controls.set_html_BANG_.call(null,"latitude-fld","<input value='0' style='width:50px' id='input-lat'\n               onchange='javascript:view3d.client.latitude(this.value)'>");

return view3d.controls.set_html_BANG_.call(null,"longitude-fld","<input value='0' style='width:50px' id='input-lon'\n               onchange='javascript:view3d.client.longitude(this.value)'>");
});
view3d.controls.show_flight_data = (function view3d$controls$show_flight_data(carr__$1){
var map__31082 = cljs.core.deref.call(null,carr__$1);
...
var coord = cljs.core.get.call(null,map__31082__$1,new cljs.core.Keyword(null,"coord","coord",-1453656639));
var course = cljs.core.get.call(null,map__31082__$1,new cljs.core.Keyword(null,"course","course",1455432948));
var speed = cljs.core.get.call(null,map__31082__$1,new cljs.core.Keyword(null,"speed","speed",1257663751));
var altitude = cljs.core.get.call(null,map__31082__$1,new cljs.core.Keyword(null,"altitude","altitude",463588637));
...
return view3d.controls.set_html_BANG_.call(null,"onboard-fld",[cljs.core.str("<select onchange='javascript:view3d.client.onboard(this.value)' style='width:96px'>"),cljs.core.str(((cljs.core.empty_QMARK_.call(null,list))?[cljs.core.str("<option value='callsign'>callsign</option>\n                   <option value='select'>select</option>")].join(''):[cljs.core.str("<option value='select'>select</option>"),cljs.core.str(cljs.core.apply.call(null,cljs.core.str,(function (){var iter__20420__auto__ = (function view3d$controls$callsigns_$_iter__31088(s__31089){
return (new cljs.core.LazySeq(null,(function (){
var s__31089__$1 = s__31089;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__31089__$1);
if(temp__4657__auto__){
var s__31089__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__31089__$2)){
var c__20418__auto__ = cljs.core.chunk_first.call(null,s__31089__$2);
var size__20419__auto__ = cljs.core.count.call(null,c__20418__auto__);
var b__31091 = cljs.core.chunk_buffer.call(null,size__20419__auto__);
if((function (){var i__31090 = (0);
while(true){
if((i__31090 < size__20419__auto__)){
var e = cljs.core._nth.call(null,c__20418__auto__,i__31090);
cljs.core.chunk_append.call(null,b__31091,[cljs.core.str("<option value='"),cljs.core.str(e),cljs.core.str("'>"),cljs.core.str(e),cljs.core.str("</option>")].join(''));

var G__31092 = (i__31090 + (1));
i__31090 = G__31092;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__31091),view3d$controls$callsigns_$_iter__31088.call(null,cljs.core.chunk_rest.call(null,s__31089__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__31091),null);
}
} else {
var e = cljs.core.first.call(null,s__31089__$2);
return cljs.core.cons.call(null,[cljs.core.str("<option value='"),cljs.core.str(e),cljs.core.str("'>"),cljs.core.str(e),cljs.core.str("</option>")].join(''),view3d$controls$callsigns_$_iter__31088.call(null,cljs.core.rest.call(null,s__31089__$2)));
}
} else {
return null;
}
...
return iter__20420__auto__.call(null,list);
