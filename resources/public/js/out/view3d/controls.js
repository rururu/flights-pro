...
var len__9613__auto___39846 = arguments.length;
var i__9614__auto___39847 = (0);
while(true){
if((i__9614__auto___39847 < len__9613__auto___39846)){
args__9620__auto__.push((arguments[i__9614__auto___39847]));

var G__39848 = (i__9614__auto___39847 + (1));
i__9614__auto___39847 = G__39848;
continue;
} else {
}
break;
...
view3d.controls.format.cljs$lang$applyTo = (function (seq39844){
var G__39845 = cljs.core.first.call(null,seq39844);
var seq39844__$1 = cljs.core.next.call(null,seq39844);
return view3d.controls.format.cljs$core$IFn$_invoke$arity$variadic(G__39845,seq39844__$1);
});
...
view3d.controls.set_html_BANG_.call(null,"temp","temp");
...
view3d.controls.set_html_BANG_.call(null,"speed-tmp","<select style='width:40px' id='input-spdtmp'>\n   <option value='1'>1</option>\n   <option value='2'>2</option>\n   <option value='3'>3</option>\n   <option value='4'>4</option>");

view3d.controls.set_html_BANG_.call(null,"altitude-tmp","<select style='width:40px' id='input-alttmp'>\n   <option value='1'>1</option>\n   <option value='2'>2</option>\n   <option value='3'>3</option>\n   <option value='4'>4</option>");
...
var map__39851 = cljs.core.deref.call(null,carr__$1);
...
var coord = cljs.core.get.call(null,map__39851__$1,new cljs.core.Keyword(null,"coord","coord",-1453656639));
var course = cljs.core.get.call(null,map__39851__$1,new cljs.core.Keyword(null,"course","course",1455432948));
var speed = cljs.core.get.call(null,map__39851__$1,new cljs.core.Keyword(null,"speed","speed",1257663751));
var altitude = cljs.core.get.call(null,map__39851__$1,new cljs.core.Keyword(null,"altitude","altitude",463588637));
...
return view3d.controls.set_html_BANG_.call(null,"onboard-fld",[cljs.core.str("<select onchange='javascript:view3d.client.onboard(this.value)' style='width:96px'>"),cljs.core.str(((cljs.core.empty_QMARK_.call(null,list))?[cljs.core.str("<option value='callsign'>callsign</option>\n                   <option value='select'>select</option>")].join(''):[cljs.core.str("<option value='select'>select</option>"),cljs.core.str(cljs.core.apply.call(null,cljs.core.str,(function (){var iter__9288__auto__ = (function view3d$controls$callsigns_$_iter__39857(s__39858){
return (new cljs.core.LazySeq(null,(function (){
var s__39858__$1 = s__39858;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__39858__$1);
if(temp__4657__auto__){
var s__39858__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__39858__$2)){
var c__9286__auto__ = cljs.core.chunk_first.call(null,s__39858__$2);
var size__9287__auto__ = cljs.core.count.call(null,c__9286__auto__);
var b__39860 = cljs.core.chunk_buffer.call(null,size__9287__auto__);
if((function (){var i__39859 = (0);
while(true){
if((i__39859 < size__9287__auto__)){
var e = cljs.core._nth.call(null,c__9286__auto__,i__39859);
cljs.core.chunk_append.call(null,b__39860,[cljs.core.str("<option value='"),cljs.core.str(e),cljs.core.str("'>"),cljs.core.str(e),cljs.core.str("</option>")].join(''));

var G__39861 = (i__39859 + (1));
i__39859 = G__39861;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__39860),view3d$controls$callsigns_$_iter__39857.call(null,cljs.core.chunk_rest.call(null,s__39858__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__39860),null);
}
} else {
var e = cljs.core.first.call(null,s__39858__$2);
return cljs.core.cons.call(null,[cljs.core.str("<option value='"),cljs.core.str(e),cljs.core.str("'>"),cljs.core.str(e),cljs.core.str("</option>")].join(''),view3d$controls$callsigns_$_iter__39857.call(null,cljs.core.rest.call(null,s__39858__$2)));
}
} else {
return null;
}
